...
set -uo pipefail
OUT=/workspace/w289_ctl.log
exec >"$OUT" 2>&1
finish() { echo "=== W289 CONTROL EXIT rc=$1 at $(date -Is) ==="; exit "$1"; }
echo "=== W289 CONTROL START $(date -Is) pid=$$ ==="
