/* VENDORED from nvkvm-pv:tests/harness/probes/mem_bandwidth_probe.c @ 368d2db
 * on 2026-09-09 for kayfabe lane (1) 'CUDA apps work'. nvkvm-pv is READ-ONLY to this
 * campaign; this copy exists so a run reproduces without that tree present.
 * ⊘ Do not edit to make a run pass — edit it and it stops being the sibling's oracle. */
/*
