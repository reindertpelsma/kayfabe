...
% ---------------------------------------------------------------- honesty box --
\node[box, fill=kfhost!30, draw=kfhostln, minimum width=178mm, minimum height=13mm] at (0,-29)
  {\textbf{\color{kfhostln}What is actually running, as of 2026-08-20 20:32 (\tc{56dc01f3}).}\\[2pt]
   ...
   \tiny ★★★★★ \textbf{SEQUENTIAL processes pass too, as of w367 (2026-08-20, rev \tc{cca2eb4b})}:
   THREE in one boot, all \tc{TORCH\_OK}, 8/8 completions each, IDENTICAL doorbell counts,\\[-0.5pt]
   \tiny 0 \tc{NVRM} 0 \tc{Xid}. ⊘ This box read \textbf{"a second context SEQUENTIALLY in one
   boot still hangs"} until 18:31 that day. \textbf{\color{kfhostln}⊘ A FOURTH process still fails;
   n = 1 boot.}\\[-0.5pt]
   \tiny \textbf{\color{kfhostln}And there is no tenant axis at all} — no \tc{VmId} anywhere in
