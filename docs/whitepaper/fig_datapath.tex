...
\node[box, fill=white, draw=kfcoreln, line width=0.8pt,
  ...
  {\textbf{\color{kfcoreln}\tc{kayfabe-gsp} — BUILT, 5\,056 L (S0--S5)}\;$\rightarrow$\;\tc{RpcCommand}\\[1pt]
   ...
   \textbf{\color{kfcoreln}★ \tc{kayfabe-rmrpc} — BUILT, 3\,265 L}\;$\rightarrow$\;\tc{RmEvent}\\[1pt]
