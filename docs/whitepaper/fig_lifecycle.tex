...
\row{-21}{T6}{isolate garbage\\ collection}
  ...
  {\textbf{\color{kfstubln}Designed; the OS half is still unexercised} — but \textbf{real isolate
   processes ARE spawned now} (\tc{HostIsolate}, a sandboxed child, first sighting \tc{t+42\,s}
   on a live boot). What is unexercised is the \emph{reaping}: no boot has reached a teardown.}
