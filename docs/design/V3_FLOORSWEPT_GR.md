...
| every `kf-*` crate test (`cargo test --no-fail-fast -p kf-…`, 17 crates), incl. `cap1_differential` 11/11, `cap1b_differential` 9/9, `host_facts_ga106` 12/12, `host_facts_query_ga106` 27/27 | `2e32b7b1` | **1476 passed, 0 failed** (113 test binaries) | box log (`/workspace/bench/gpcm/crates_2e32b7b1.log`) |
