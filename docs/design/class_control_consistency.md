...
**STATUS: LIVE, 2026-08-14 (w295).** The mechanism has landed. The **case** — whether
`GT200_DEBUGGER` should be denied at all — is **open and reserved to the owner**; §5 states it
