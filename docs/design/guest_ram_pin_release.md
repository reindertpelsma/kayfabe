...
| **C** | `kayfabe: PIN-RELEASE released=N …` appears with **N > 0** | ★ The non-vacuity. A green boot that never released a pin proves the release did not regress anything and proves **nothing about the release**. Grade as a **floor**. |
