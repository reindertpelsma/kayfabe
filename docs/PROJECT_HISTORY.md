...
>
> For *current* state read [`STATUS_DETAIL.md`](STATUS_DETAIL.md) (rewritten for v3 on
> 2026-09-26). ⊘ The whitepaper (`whitepaper/kayfabe_architecture.pdf`) describes the **pre-v3**
> tree; the v3 design is [`design/THE_ARCHITECTURE_v3.md`](design/THE_ARCHITECTURE_v3.md) and
> [`pdf/kayfabe_architecture_v3.pdf`](pdf/kayfabe_architecture_v3.pdf).
