...
APPRES side=host app=vectorAdd verdict=PASS rc=0 secs=3 quiet=0 note=-
APPRES side=host app=vectorAddDrv verdict=PASS rc=0 secs=2 quiet=0 note=-
APPRES side=host app=matrixMul verdict=PASS rc=0 secs=2 quiet=0 note=-
APPRES side=host app=matrixMulDrv verdict=PASS rc=0 secs=3 quiet=1 note=-
...
APPRES side=host app=simpleAtomicIntrinsics verdict=PASS rc=0 secs=3 quiet=0 note=-
APPRES side=host app=simpleCallback verdict=PASS rc=0 secs=2 quiet=0 note=-
APPRES side=host app=simpleOccupancy verdict=PASS rc=0 secs=3 quiet=0 note=-
...
APPRES side=host app=simpleIPC verdict=PASS rc=0 secs=3 quiet=1 note=-
APPRES side=host app=UnifiedMemoryStreams verdict=PASS rc=0 secs=3 quiet=1 note=-
APPRES side=host app=UnifiedMemoryPerf verdict=PASS rc=0 secs=19 quiet=0 note=-
...
APPRES side=host app=cudaTensorCoreGemm verdict=PASS rc=0 secs=5 quiet=1 note=-
APPRES side=host app=bf16TensorCoreGemm verdict=PASS rc=0 secs=9 quiet=1 note=-
APPRES side=host app=globalToShmemAsyncCopy verdict=PASS rc=0 secs=2 quiet=0 note=-
APPRES side=host app=cdpSimpleQuicksort verdict=PASS rc=0 secs=3 quiet=0 note=-
APPRES side=host app=graphMemoryNodes verdict=PASS rc=0 secs=5 quiet=0 note=-
APPRES side=host app=simpleCudaGraphs verdict=PASS rc=0 secs=3 quiet=0 note=-
APPRES side=host app=simpleCUBLAS verdict=PASS rc=0 secs=3 quiet=1 note=-
APPRES side=host app=simpleCUFFT verdict=PASS rc=0 secs=2 quiet=0 note=-
APPRES side=host app=conjugateGradient verdict=PASS rc=0 secs=3 quiet=0 note=warn:Test Summary: Error amount = 0.000000
APPRES side=host app=MersenneTwisterGP11213 verdict=PASS rc=0 secs=2 quiet=0 note=warn:Max absolute error: 0.000000E+00
...
APPRES side=host app=scan verdict=PASS rc=0 secs=4 quiet=0 note=-
...
APPRES side=host app=transpose verdict=PASS rc=0 secs=3 quiet=0 note=-
APPRES side=host app=stream_triad verdict=PASS rc=0 secs=3 quiet=0 note=-
APPRES side=host app=reduce verdict=PASS rc=0 secs=4 quiet=1 note=-
APPRES side=host app=nbody verdict=PASS rc=0 secs=2 quiet=0 note=-
APPRES side=host app=blackscholes verdict=PASS rc=0 secs=3 quiet=1 note=-
APPRES side=host app=mandelbrot verdict=PASS rc=0 secs=2 quiet=0 note=-
APPRES side=host app=conv2d verdict=PASS rc=0 secs=3 quiet=0 note=-
...
APPRES side=host app=gpu_burn verdict=PASS rc=0 secs=99 quiet=0 note=warn:cuInit returned 0 (no error)
...
APPRES side=host app=torch_ai_bench verdict=PASS rc=0 secs=32 quiet=1 note=-
APPRES side=host app=hf_generate verdict=PASS rc=0 secs=12 quiet=1 note=-
...
APPDIG side=host app=llama_cpp_gen OUTSHA llama_cpp ad3b33b08f073631
...
APPRES side=host app=vkpeak verdict=PASS rc=0 secs=456 quiet=1 note=-
APPRES side=host app=egl_offscreen verdict=PASS rc=0 secs=18 quiet=1 note=-
APPRES side=host app=clinfo verdict=PASS rc=0 secs=4 quiet=0 note=-
APPRES side=host app=clpeak verdict=PASS rc=0 secs=102 quiet=0 note=-
APPRES side=host app=nvenc_h264 verdict=PASS rc=0 secs=7 quiet=0 note=-
APPRES side=host app=nvenc_hevc verdict=PASS rc=0 secs=8 quiet=0 note=-
APPRES side=host app=nvdec_h264 verdict=PASS rc=0 secs=9 quiet=0 note=-
APPRES side=host app=hashcat verdict=PASS rc=0 secs=7 quiet=1 note=warn:[33mThis means that hashcat cannot use the full parallel power of your device(s).[0m
APPRES side=host app=blender_cycles verdict=PASS rc=0 secs=9 quiet=0 note=-
