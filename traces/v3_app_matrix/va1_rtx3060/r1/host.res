...
APPRES side=host app=bandwidthTest verdict=PASS rc=0 secs=4 quiet=1 note=-
APPRES side=host app=simpleStreams verdict=PASS rc=0 secs=3 quiet=0 note=-
...
APPRES side=host app=concurrentKernels verdict=PASS rc=0 secs=2 quiet=0 note=-
APPRES side=host app=simpleIPC verdict=PASS rc=0 secs=3 quiet=0 note=-
...
APPRES side=host app=globalToShmemAsyncCopy verdict=PASS rc=0 secs=3 quiet=0 note=-
APPRES side=host app=cdpSimpleQuicksort verdict=PASS rc=0 secs=3 quiet=1 note=-
...
APPRES side=host app=MersenneTwisterGP11213 verdict=PASS rc=0 secs=3 quiet=1 note=warn:Max absolute error: 0.000000E+00
APPRES side=host app=reduction verdict=PASS rc=0 secs=2 quiet=0 note=-
APPRES side=host app=sortingNetworks verdict=PASS rc=0 secs=10 quiet=0 note=-
...
APPRES side=host app=BlackScholes verdict=PASS rc=0 secs=3 quiet=1 note=warn:Max absolute error: 1.192093E-05
...
APPRES side=host app=nbody verdict=PASS rc=0 secs=3 quiet=0 note=-
...
APPRES side=host app=sgemm_cublas verdict=PASS rc=0 secs=3 quiet=1 note=-
...
APPRES side=host app=attach_verify verdict=PASS rc=0 secs=2 quiet=0 note=-
APPRES side=host app=gpu_burn verdict=PASS rc=0 secs=99 quiet=0 note=warn:cuInit returned 0 (no error)
APPRES side=host app=torch_correct verdict=PASS rc=0 secs=9 quiet=2 note=-
APPDIG side=host app=torch_correct DIGEST cnn_train_step 763c693a5a53f948
APPRES side=host app=torch_ai_bench verdict=PASS rc=0 secs=39 quiet=1 note=-
APPRES side=host app=hf_generate verdict=PASS rc=0 secs=10 quiet=1 note=-
...
APPDIG side=host app=llama_cpp_gen OUTSHA llama_cpp d238af5a29875cce
...
APPRES side=host app=vkpeak verdict=PASS rc=0 secs=400 quiet=0 note=-
APPRES side=host app=egl_offscreen verdict=PASS rc=0 secs=25 quiet=0 note=-
APPRES side=host app=clinfo verdict=PASS rc=0 secs=5 quiet=1 note=-
APPRES side=host app=clpeak verdict=PASS rc=0 secs=147 quiet=0 note=-
...
APPRES side=host app=hashcat verdict=PASS rc=0 secs=6 quiet=1 note=warn:[33mThis means that hashcat cannot use the full parallel power of your device(s).[0m
APPRES side=host app=blender_cycles verdict=PASS rc=0 secs=10 quiet=0 note=-
APPRES side=host app=geekbench_gpu verdict=PASS rc=0 secs=63 quiet=0 note=warn: unknown error (internal code 35)
