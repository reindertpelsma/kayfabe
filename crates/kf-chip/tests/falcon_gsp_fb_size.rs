//! The falcon GSP model (Ampere, Ada)'s WPR2 answers are a function of the FB size it was BUILT with — never a
...
use kf_chip::falcon_gsp::{FalconGspModel, frts_offset_for, gsp_fw_wpr_end_for};

fn wpr2(m: &FalconGspModel) -> (u64, u64) {
...
fn wpr2_follows_the_size_the_model_was_built_with() {
    let a = FalconGspModel::with_fb_size_mb(256);
    let b = FalconGspModel::with_fb_size_mb(11_857);
