...
//!
//! `kf_linux_raw::memtype` reports what memory type the kernel actually installed.
...
/// `kf_linux_raw::kvm_gate::report` does and for exactly the same reason.
fn record(line: &str) {
