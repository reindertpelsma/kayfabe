...
//!
//! `kf_gsp::GspFsm::new` takes a [`GspAbi`] — a bundle of the `msgq` constants, the
...
//! [`kf_abi::versions::table_for`], which refuses below its floor rather than
...
/// # Errors
///
/// [`kf_abi::wire::AbiError::NoTableForVersion`] below the supported floor, or
