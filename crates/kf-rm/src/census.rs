...
use kf_abi::eventnotify::{ACTION_OFF, EVENT_OFF, NV2080_CTRL_CMD_EVENT_SET_NOTIFICATION};
...
pub struct CensusSnapshot {
    ...
    pub probe_arm: kf_abi::eventnotify::ProbeArmSet,
...
impl ControlCensusLog {
    ...
    pub fn set_probe_arm(&self, probe_arm: kf_abi::eventnotify::ProbeArmSet) {
...
impl<P: CommandPolicy> CommandPolicy for ControlCensus<P> {
    ...
    fn respond(&mut self, cmd: &RpcCommand) -> Option<Reply> {
        ...
        if let Some(req) = req {
            ...
            if req.cmd == kf_abi::submit::NVA06F_CTRL_CMD_BIND {
                ...
                self.log.note_bind(ChannelBind {
                    ...
                    ce_index: kf_abi::submit::copy_index_of_engine_type(engine_type)
