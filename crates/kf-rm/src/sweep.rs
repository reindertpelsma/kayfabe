...
//! anything it does not serve (`kf_gsp::GspFsm::answer`) — stops meaning *"refused"*:
//!
//! ```c
...
pub static SWEEP_TRIAGE: &[SweepControl] = &[
    ...
    // ── seq 8 ──────────────────────────────────────────────────────────────────────
    SweepControl {
        cmd: kf_abi::deviceinfo::NV2080_CTRL_CMD_INTERNAL_GET_DEVICE_INFO_TABLE,
        engine: "KernelFifo",
    ...
    // ── seq 11 ─────────────────────────────────────────────────────────────────────
    SweepControl {
        cmd: kf_abi::memsysconfig::NV2080_CTRL_CMD_INTERNAL_MEMSYS_GET_STATIC_CONFIG,
    ...
    // ── seq 13 and 44 ──────────────────────────────────────────────────────────────
    SweepControl {
        cmd: kf_abi::confcompute::NV2080_CTRL_CMD_INTERNAL_CONF_COMPUTE_GET_STATIC_INFO,
    ...
    // ── seq 14 ─────────────────────────────────────────────────────────────────────
    SweepControl {
        cmd: kf_abi::bifstatic::NV2080_CTRL_CMD_INTERNAL_BIF_GET_STATIC_INFO,
        engine: "KernelBif",
        disposition: SweepDisposition::RefusalFailsOpen,
    ...
    // ── seq 15, 16, 17 and 34 ──────────────────────────────────────────────────────
    SweepControl {
        cmd: kf_abi::fifochannels::NV2080_CTRL_CMD_INTERNAL_FIFO_GET_NUM_CHANNELS,
        engine: "KernelFifo",
    ...
    SweepControl {
        ...
        why: "★ RECLASSIFIED from RefusalIsInvisible by boot irq1 at bb4f48d, then \
              ...
              ([measured] traces/real_ga106/, and see kf_abi::fmbsize for the five \
    ...
    SweepControl {
        ...
        why: "NV2080_CTRL_CMD_EVENT_SET_NOTIFICATION is the event-registration verb, not an \
              ...
              reason — kf_abi::eventnotify::SILENT_NOTIFIERS — and every other \
    ...
    // ── seq 26 ─────────────────────────────────────────────────────────────────────
    SweepControl {
        cmd: kf_abi::gmmustatic::NV2080_CTRL_CMD_INTERNAL_GMMU_GET_STATIC_INFO,
        engine: "KernelGmmu",
        disposition: SweepDisposition::AmputationUnsurvivable,
    ...
    SweepControl {
        ...
        why: "kmemsysSendL2InvalidateEvict_IMPL returns the control's status verbatim \
              ...
              traces/real_ga106/rpc_bodies_real_ga106.txt; kf_abi::oracle). The NV_OK \
              ...
              port's own, and any second writer of the framebuffer — and kf_abi::l2evict \
    ...
    SweepControl {
        ...
        why: "_gvaspaceCopyServerReservedPdes issues it under NV_ASSERT_OK_OR_RETURN after \
              ...
              kf_abi::gvaspacepdes and docs/design/mode2_address_table.md",
    },
    // ── seq 49, 50 and 51 ──────────────────────────────────────────────────────────
    ...
    SweepControl {
        ...
        why: "GET_INFO, 3712 bytes. kgraphicsLoadStaticInfo takes its status into a bare \
              ...
              ⊘ Contrast kf_abi::oracle: a dlen=0 row would have cited the same file \
    ...
    SweepControl {
        ...
        why: "★★★ NVA06F_CTRL_CMD_BIND (ogkm-580: ctrla06fgpfifo.h:96), one [IN] NvU32 \
              ...
              — the [IN] engineType echoed back (kf_abi::oracle, traces/real_ga106/). \
...
kf_util::assert_send_sync!(SweepControl, SweepDisposition);
