...
//! (`kf_gsp::GspFsm::answer` carries the measurement that forced it). That is the
...
/// [`kf_abi::fbinfo`] for the whole measurement.
...
kf_util::assert_send_sync!(UnservicedCommand, UnservicedLog, UnservicedLedger);
