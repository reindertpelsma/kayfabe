...
//!
//! So this file `use`s **nothing** — not `kf_abi`, not `kf_rmrpc`, not
//! `kf_gsp`. Every offset below is a literal, written beside the `ogkm` line it came
...
/// whole job.** `kf_abi::notifier::ChannelEngineWire::V580` states the same offset;
...
/// Transcribed independently of `kf_abi::generated::classes`, same reasoning.
