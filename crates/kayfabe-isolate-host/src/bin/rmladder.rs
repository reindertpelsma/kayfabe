...
fn main() -> std::process::ExitCode {
    ...
    // ★ R30 runs here and RETURNS, for R25's reason: it allocates its own address space,
    // its own objects and its own memfd, and leaving the rest of the ladder unrun keeps
    // every refusal attributable to the CPU-view chain alone.
