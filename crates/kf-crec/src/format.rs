...
use kf_arch::ids::Gpa;
use kf_trace::{Bar, IrqSpec, Record, Seq, TraceEvent, Width};
...
impl CTrace {
    ...
    /// The stream as [`kf_trace::Record`]s, so [`kf_trace::check_dense_order`]
...
kf_util::assert_send_sync!(CTrace, CRecord, CHeader, CKind, CrecError);
