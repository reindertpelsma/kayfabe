...
//! [`kf_abi::oracle::EMPTY_CAPTURE_ROWS`] carries a `real` body per row, and
//! [`kf_abi::grinfo::GA106_GR_INFO`] carries 58 words; both are transcriptions, and a
...
use kf_abi::oracle::EMPTY_CAPTURE_ROWS;
