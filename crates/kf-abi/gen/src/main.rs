...
///
/// Emitted as a [`kf_abi::wire::Drf`], which keeps `hi` and `lo` together so
...
const CLC076_H: &str = "src/common/sdk/nvidia/inc/class/clc076.h";
...
// by `kf_arch::HostClasses`' implementations in `kayfabe-chips`; decision #2's
