...
/// `ADA_COMPUTE_A` — Ada's compute engine object, the generation's counterpart to
/// [`AMPERE_COMPUTE_B`].
///
...
///
/// ogkm `src/common/sdk/nvidia/inc/class/clc9c0.h`.
pub const ADA_COMPUTE_A: u32 = 0xc9c0;

/// `HOPPER_COMPUTE_A` — Hopper's compute engine object. See [`ADA_COMPUTE_A`] for why
/// this is generated rather than written down.
///
/// ogkm `src/common/sdk/nvidia/inc/class/clcbc0.h`.
...
/// `NV_CHANNEL_GROUP_ALLOCATION_PARAMETERS` — ogkm `src/common/sdk/nvidia/inc/nvos.h:2904`.
#[repr(C)]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub struct NvChannelGroupAllocationParameters {
    /// `NvHandle hObjectError` @ +0 (src/common/sdk/nvidia/inc/nvos.h:2906).
    pub h_object_error: u32,
    /// `NvHandle hObjectEccError` @ +4 (src/common/sdk/nvidia/inc/nvos.h:2907).
    pub h_object_ecc_error: u32,
    /// `NvHandle hVASpace` @ +8 (src/common/sdk/nvidia/inc/nvos.h:2908).
    pub h_va_space: u32,
    /// `NvU32 engineType` @ +12 (src/common/sdk/nvidia/inc/nvos.h:2909).
    pub engine_type: u32,
    /// `NvBool bIsCallingContextVgpuPlugin` @ +16 (src/common/sdk/nvidia/inc/nvos.h:2910).
...
/// `NV_CTXSHARE_ALLOCATION_PARAMETERS` — ogkm `src/common/sdk/nvidia/inc/nvos.h:3232`.
#[repr(C)]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub struct NvCtxshareAllocationParameters {
    /// `NvHandle hVASpace` @ +0 (src/common/sdk/nvidia/inc/nvos.h:3234).
    pub h_va_space: u32,
    /// `NvU32 flags` @ +4 (src/common/sdk/nvidia/inc/nvos.h:3235).
    pub flags: u32,
    /// `NvU32 subctxId` @ +8 (src/common/sdk/nvidia/inc/nvos.h:3236).
    pub subctx_id: u32,
}
