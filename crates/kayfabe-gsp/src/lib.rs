//! # kayfabe-gsp — the faked GSP (SKELETON this milestone)
//!
...
//!   half is `kayfabe-completion` and stays per-proc.
//! - **RPC decode/encode** against `kayfabe-abi`'s generated message layouts, emitting
...
kayfabe_util::assert_send_sync!(BootPhase);
