...
/// `NV0080_CTRL_DMA_SET_PAGE_DIRECTORY_PARAMS` — ogkm `src/common/sdk/nvidia/inc/ctrl/ctrl0080/ctrl0080dma.h:832`.
#[repr(C)]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub struct Nv0080CtrlDmaSetPageDirectoryParams {
    /// `NvU64 physAddress` @ +0 (src/common/sdk/nvidia/inc/ctrl/ctrl0080/ctrl0080dma.h:833).
    pub phys_address: u64,
    /// `NvU32 numEntries` @ +8 (src/common/sdk/nvidia/inc/ctrl/ctrl0080/ctrl0080dma.h:834).
    pub num_entries: u32,
    /// `NvU32 flags` @ +12 (src/common/sdk/nvidia/inc/ctrl/ctrl0080/ctrl0080dma.h:835).
    pub flags: u32,
    /// `NvHandle hVASpace` @ +16 (src/common/sdk/nvidia/inc/ctrl/ctrl0080/ctrl0080dma.h:836).
    pub h_va_space: u32,
    /// `NvU32 chId` @ +20 (src/common/sdk/nvidia/inc/ctrl/ctrl0080/ctrl0080dma.h:837).
    pub ch_id: u32,
    /// `NvU32 subDeviceId` @ +24 (src/common/sdk/nvidia/inc/ctrl/ctrl0080/ctrl0080dma.h:838).
    pub sub_device_id: u32,
    /// `NvU32 pasid` @ +28 (src/common/sdk/nvidia/inc/ctrl/ctrl0080/ctrl0080dma.h:839).
    pub pasid: u32,
}
...
/// `NV2080_CTRL_GPU_PROMOTE_CTX_BUFFER_ENTRY` — ogkm `src/common/sdk/nvidia/inc/ctrl/ctrl2080/ctrl2080gpu.h:922`.
#[repr(C)]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub struct Nv2080CtrlGpuPromoteCtxBufferEntry {
    /// `NvU64 gpuPhysAddr` @ +0 (src/common/sdk/nvidia/inc/ctrl/ctrl2080/ctrl2080gpu.h:923).
    pub gpu_phys_addr: u64,
    /// `NvU64 gpuVirtAddr` @ +8 (src/common/sdk/nvidia/inc/ctrl/ctrl2080/ctrl2080gpu.h:924).
    pub gpu_virt_addr: u64,
    /// `NvU64 size` @ +16 (src/common/sdk/nvidia/inc/ctrl/ctrl2080/ctrl2080gpu.h:925).
    pub size: u64,
    /// `NvU32 physAttr` @ +24 (src/common/sdk/nvidia/inc/ctrl/ctrl2080/ctrl2080gpu.h:926).
    pub phys_attr: u32,
    /// `NvU16 bufferId` @ +28 (src/common/sdk/nvidia/inc/ctrl/ctrl2080/ctrl2080gpu.h:927).
    pub buffer_id: u16,
    /// `NvU8 bInitialize` @ +30 (src/common/sdk/nvidia/inc/ctrl/ctrl2080/ctrl2080gpu.h:928).
    pub b_initialize: u8,
    /// `NvU8 bNonmapped` @ +31 (src/common/sdk/nvidia/inc/ctrl/ctrl2080/ctrl2080gpu.h:929).
    pub b_nonmapped: u8,
}
